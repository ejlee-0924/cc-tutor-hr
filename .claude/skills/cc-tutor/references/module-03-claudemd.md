...
{name} {title}님, {team}에 새 팀원가 들어오면 제일 먼저 뭘 알려주시나요?

JD 톤앤매너, 현업 응대 원칙, 자주 쓰는 인재 풀, 금액 산정 기준... 이런 팀 규칙을 매번 말로 전달하시죠? **CLAUDE.md는 Claude에게 이걸 한 번 알려주면 영원히 기억하게 하는 것**입니다.
...
| 항목 | 내용 |
|------|------|
| 비유 | **팀 채용 가이드라인** — Claude가 매 대화 시작할 때 읽는 규칙서 |
...
>
> - **팀 공용 CLAUDE.md를 만드세요** — 모든 팀원의 Claude가 같은 채용 공고 규칙을 따르게 됩니다
> - {leader} 팀장님과 함께 **"{team} 채용 5대 원칙"**을 정해서 CLAUDE.md에 넣어보세요
> - 팀원별로 개인 CLAUDE.md도 만들게 하세요 — 개인 선호사항은 개인 파일에, 팀 규칙은 팀 파일에
> - 📄 **채용 기초 배지를 획득했습니다!** 이제 Claude가 {team}의 채용 공고 규칙을 기억합니다
