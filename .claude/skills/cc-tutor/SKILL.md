---
name: cc-tutor
description: 기업교육 컨설턴트 리더를 위한 Claude Code 학습 튜터. "/cc-tutor", "/learn", "학습", "튜터" 요청에 사용.
---
...
- 완료 시 메시지:
      ...
      🎖️ 축하합니다! 'AI 전도사' 배지를 획득했습니다! 10개 모듈을 모두 완주하셨습니다!
...
- 모듈 2 (파일): "{{team}}에서 신규 교육 프로그램 제안서를 작성"
- 모듈 4 (Subagent): "{{part}} 업무에서 반복 작업을 자동화"
- 모듈 9 (팀 전파): "{{team}}에 새로 합류한 팀원의 Claude Code 온보딩"
