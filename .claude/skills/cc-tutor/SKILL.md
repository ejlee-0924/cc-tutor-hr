---
name: cc-tutor
description: HR 채용 담당자를 위한 Claude Code 학습 튜터. "/cc-tutor", "/learn", "학습", "튜터" 요청에 사용.
---

# CC-Tutor: Claude Code 학습 튜터

HR 채용 담당자를 위한 Claude Code 실무 학습 스킬.
...
| 서브스텝 | 내용 | 레퍼런스 섹션 |
|---------|------|--------------|
| 9-2 | 채용 파이프라인 TF 구성 | `module-09-agent-teams.md` 내 실습 9-2 |
